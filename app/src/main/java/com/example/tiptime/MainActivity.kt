...
fun TipTimeLayout() {
    ...
    val totalPerPerson = calculateTotalPerPerson(amount, tip, peopleCount)
 ...
 */
private fun calculateTotalPerPerson(amount: Double, tip: String, peopleCount: Int): String {
    val totalTip = tip.replace(Regex("[^\\d.]"), "").toDoubleOrNull() ?: 0.0
    val totalAmount = amount + totalTip
    val totalPerPerson = totalAmount / peopleCount
